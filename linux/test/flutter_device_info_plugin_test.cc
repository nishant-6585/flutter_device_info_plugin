...
#include "include/flutter_device_info_plugin/flutter_device_info_plugin.h"
#include "flutter_device_info_plugin_private.h"
...
TEST(FlutterDeviceInfoPlugin, GetPlatformVersion) {
